    ...
    <div style={{ fontFamily: "'Google Sans', Roboto, Arial, sans-serif", background: '#fff', color: '#202124', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          {/* Logo — relative path works from /clientReview/ base */}
          <a href="/clientReview/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            <img src="/clientReview/image.png" alt="Certifyied" style={{ height: 32, objectFit: 'contain' }} />
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '120px 24px 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginBottom: 28 }}>
            <img src="/clientReview/image.png" alt="Certifyied Reviews" style={{ height: 48, objectFit: 'contain' }} />
      ...
      <footer style={{ padding: '40px 24px', background: '#202124', color: 'rgba(255,255,255,0.6)', fontSize: 13 }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <img src="/clientReview/image.png" alt="Certifyied" style={{ height: 24, objectFit: 'contain', filter: 'brightness(0) invert(1)', opacity: 0.7 }} />
